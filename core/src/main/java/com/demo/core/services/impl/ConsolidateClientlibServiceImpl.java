...
public class ConsolidateClientlibServiceImpl implements ConsolidateClientlibService {
    ...
    private final String CLIENTLIB_ROOT_FOLDER = "/etc/clientlibs";
    ...
    private static String clientlibPath = null;
    ...
    public void create(SlingHttpServletRequest slingRequest) {
        ...
        try {
            ...
            categories.add(currentPage.getAbsoluteParent(1).getName() + "." + currentPage.getName());
            ...
            clientlibPath = CLIENTLIB_ROOT_FOLDER + SLASH + currentPage.getAbsoluteParent(1)
                    .getName() + SLASH + "clientlib-" + currentPage.getName();
            Resource source = ResourceUtil.getOrCreateResource(resourceResolver, clientlibPath,
            ...
            if (Objects.isNull(source.getChild(JS_TXT_FILE))) {
                Resource jsResource = resourceResolver.create(source, JS_TXT_FILE,
            ...
            if (Objects.isNull(source.getChild(CSS_TXT_FILE))) {
                Resource cssResource = resourceResolver.create(source, CSS_TXT_FILE,
                        Collections.singletonMap(JcrConstants.JCR_PRIMARYTYPE, JcrConstants.NT_FILE));
    ...
    public void delete(SlingHttpServletRequest slingRequest) {
        ...
        try {
            ...
            Resource resource = resourceResolver.getResource(clientlibPath);
